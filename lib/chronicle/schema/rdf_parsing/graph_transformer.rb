module Chronicle::Schema::RDFParsing
  ...
  class GraphTransformer
    ...
    def pick_subclass(subclass_identifier, &)
      subclass = @base_graph.find_class(subclass_identifier)
    ...
    def pick_all_subclasses(&)
      @base_graph.find_class_by_id(@current_parent.id).subclass_ids.each do |subclass_id|
    ...
    def pick_all_properties
      @base_graph.find_class_by_id(@current_parent.id).properties.each do |property|
