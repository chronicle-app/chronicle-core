...
RSpec.describe Chronicle::Serialization::Serializer do
  describe '#initialize' do
    it 'creates a new instance of the serializer' do
      expect do
        Chronicle::Serialization::Serializer.new(Chronicle::Models::Base.new)
    ...
    it 'raises an error if the record is not a Chronicle Model' do
      ...
      end.to raise_error(Chronicle::Serialization::SerializationError)
    end
  end
  ...
  describe '#serializable_hash' do
    it 'is not implemented in base serializer' do
      expect do
        Chronicle::Serialization::Serializer.serialize(Chronicle::Models::Base.new)
